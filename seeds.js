...
async function main () {
  try {
    ...
    const reviewersValues = [
      ['Robert Smith', 'The Daily Reviewer', 'https://rampupsa.blob.core.windows.net/ramppuimages/RoberthSmith.webp'],
      ['Chris Harris', 'International Movie Critic', 'https://rampupsa.blob.core.windows.net/ramppuimages/ChrisHarris.webp'],
      ['Janet Garcia', 'MoviesNow', 'https://rampupsa.blob.core.windows.net/ramppuimages/YanetGarcia.webp'],
      ['Andrew West', 'MyNextReview', 'https://rampupsa.blob.core.windows.net/ramppuimages/AndrewWest.webp'],
      ['Mindy Lee', 'Movies n\' Games', 'https://rampupsa.blob.core.windows.net/ramppuimages/MindyLee.webp'],
      ['Martin Thomas', 'TheOne', 'https://rampupsa.blob.core.windows.net/ramppuimages/MartinThomas.webp'],
      ['Anthony Miller', 'ComicBookHero.com', 'https://rampupsa.blob.core.windows.net/ramppuimages/AnthonyMiller.webp']
    ]
